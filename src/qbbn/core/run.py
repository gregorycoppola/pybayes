...
class RunStore:
    ...
    def create(self, doc_id: str, kb_path: str, parent_run_id: str | None = None) -> str:
        ...
        # Add to doc's run list
        self.client.rpush(self._doc_runs_key(doc_id), run_id)
        
        # If branching, copy parent's layer data
        if parent_run_id:
    ...
    def _copy_layer_data(self, from_run_id: str, to_run_id: str):
        """Copy all layer data from parent run."""
